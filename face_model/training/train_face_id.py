...
class FaceIDTrainer:
    ...
    def train_epoch(self, dataloader):
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            # Get average identity token per clip
            clip_identity_tokens = identity_tokens.mean(dim=1)  # (B, 384)
...
def main():
    ...
    config = {
        ...
        'training': {
            ...
            'data_dir': '../test_output',  # Update this path
            'max_samples': 20,  # For debugging, remove for full training
